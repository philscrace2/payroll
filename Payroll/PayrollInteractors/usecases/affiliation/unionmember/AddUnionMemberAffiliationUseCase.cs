...
namespace PayrollInteractors.usecases.affiliation.unionmember
{
    public class AddUnionMemberAffiliationUseCase : EmployeeGatewayCommandUseCase<AddUnionMemberAffiliationRequest>
    {
        ...
        public AddUnionMemberAffiliationUseCase(TransactionalRunner transactionalRunner, EmployeeGateway employeeGateway, AffiliationFactory affiliationFactory
        ...
        protected override void ExecuteInTransaction(AddUnionMemberAffiliationRequest request)
        {
            ...
            Validator validator = new Validator(request, employeeGateway);
